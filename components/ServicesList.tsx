...
export default function ServicesList({ initialServices }: ServicesListProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="rounded-lg border border-foreground/10 bg-background p-6">
          <h2 className="mb-4 text-lg font-semibold text-foreground">Nouveau service</h2>
      ...
      {services.length === 0 ? (
        <div className="rounded-lg border border-foreground/10 bg-foreground/5 p-12 text-center">
          <p className="text-foreground/60">Aucun service pour le moment</p>
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  {service.category && (
                    <p className="mt-1 text-xs text-foreground/40">{service.category}</p>
                  )}
                </div>
                <button
              ...
              <div className="mt-4 flex items-center justify-between">
                <span className="text-lg font-bold text-foreground">{service.price.toFixed(2)} €</span>
                {service.duration && (
