      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            image:
              "https://www.solkant.com/images/og/pillar-logiciel-devis.png",
        ...
        <article className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <nav className="mb-12 rounded-lg bg-foreground/5 p-6">
            ...
            <ol className="space-y-2 text-foreground/70">
              ...
              <li>
                <a
                  href="#pourquoi-en-avoir-besoin"
                  className="hover:text-foreground"
                >
                  3. Pourquoi votre institut a besoin d&apos;un logiciel de
                  devis
                </a>
              </li>
              <li>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section id="introduction" className="mb-16">
              ...
              <p className="text-foreground/80 leading-relaxed mb-4">
                Vous passez encore 15 à 20 minutes à créer chaque devis sur
                Excel ou Word ? Vous cherchez désespérément le bon modèle,
                recalculez manuellement les totaux, et devez ensuite convertir
                en PDF avant d&apos;envoyer ? Cette méthode artisanale vous
                coûte du temps précieux et donne une image amateur de votre
                institut.
              </p>
              <p className="text-foreground/80 leading-relaxed">
                ...
                pourquoi et comment franchir le cap de la digitalisation pour
                vos devis.
              </p>
            </section>
            ...
            <section id="quest-ce-quun-logiciel" className="mb-16">
              <h2 className="text-3xl font-bold text-foreground mb-6">
                Qu&apos;est-ce qu&apos;un logiciel de devis pour institut de
                beauté ?
              </h2>
              <p className="text-foreground/80 leading-relaxed mb-6">
                Un logiciel de devis est une application web ou mobile
                spécialement conçue pour simplifier la création, l&apos;envoi et
                le suivi de devis professionnels. Contrairement à un simple
                modèle Excel, c&apos;est un outil complet qui :
              </p>
              <ul className="list-disc pl-6 space-y-3 text-foreground/80 mb-6">
                ...
                <li>
                  <strong>Génère automatiquement les PDF</strong> : Plus besoin
                  de convertir, le document professionnel est créé
                  instantanément
                </li>
                <li>
                ...
                <li>
                  <strong>Stocke l&apos;historique</strong> : Retrouvez tous les
                  devis d&apos;une cliente en 2 clics
                </li>
                <li>
              ...
              <p className="text-foreground/80 leading-relaxed">
                La différence fondamentale avec Excel ? L&apos;automatisation
                complète et la gestion intelligente. Vous ne partez plus
                d&apos;une feuille blanche à chaque fois.
              </p>
            </section>
            ...
            <section id="pourquoi-en-avoir-besoin" className="mb-16">
              ...
              <p className="text-foreground/80 leading-relaxed mb-6">
                ...
                devis/semaine = 20-30 minutes.{" "}
                <strong>Gain : 2h/semaine = 8h/mois = 96h/an</strong>.
              </p>
              ...
              <p className="text-foreground/80 leading-relaxed mb-6">
                Un devis PDF élégant avec votre logo, une mise en page soignée
                et une numérotation professionnelle (DEVIS-2025-047) inspire
                confiance. Vos clientes vous perçoivent comme une
                professionnelle sérieuse et organisée, ce qui justifie vos
                tarifs premium.
              </p>
              ...
              <p className="text-foreground/80 leading-relaxed mb-6">
                ...
                les oublis qui peuvent coûter cher en cas de contrôle ou de
                litige.
              </p>
              ...
              <p className="text-foreground/80 leading-relaxed mb-6">
                ...
                taux de conversion ? Quelle cliente n&apos;a pas répondu depuis
                7 jours ? Avec un logiciel, ces réponses sont à portée de clic.
                Vous pilotez votre activité avec des données concrètes.
              </p>
            ...
            <div className="my-12 rounded-xl bg-gradient-to-r from-purple-50 to-pink-50 p-8 text-center border border-foreground/10">
              ...
              <p className="text-foreground/70 mb-6 max-w-xl mx-auto">
                Créez vos premiers devis professionnels en 2 minutes. Plan
              ...
              <div className="space-y-8">
                <div className="rounded-lg bg-foreground/5 p-6">
                  ...
                  <p className="text-foreground/80 leading-relaxed">
                    ...
                    prêt à envoyer, avec votre logo, vos couleurs, et une mise
                    en page élégante. Pas besoin de passer par Word puis
                    &quot;Enregistrer sous PDF&quot;. Un clic = un document
                    impeccable.
                  </p>
                </div>
                ...
                <div className="rounded-lg bg-foreground/5 p-6">
                  ...
                  <p className="text-foreground/80 leading-relaxed">
                    ...
                    adresse) avec l&apos;historique de tous ses devis. Vous
                    retrouvez instantanément ce que vous lui avez proposé il y a
                    3 mois, facilitant les relances et la fidélisation.
                  </p>
                </div>
                ...
                <div className="rounded-lg bg-foreground/5 p-6">
                  ...
                  <p className="text-foreground/80 leading-relaxed">
                    ...
                    plupart des soins), et affiche le montant TTC. Vous ajustez
                    les quantités, et les calculs se mettent à jour
                    instantanément. Zéro risque d&apos;erreur.
                  </p>
                </div>
                ...
                <div className="rounded-lg bg-foreground/5 p-6">
                  ...
                  <p className="text-foreground/80 leading-relaxed">
                    Chaque devis reçoit un numéro unique incrémenté
                    automatiquement (DEVIS-2025-001, DEVIS-2025-002, etc.). Plus
                    besoin de vous souvenir du dernier numéro utilisé ou de
                    gérer manuellement la séquence.
                  </p>
                </div>
                ...
                <div className="rounded-lg bg-foreground/5 p-6">
                  ...
                  <p className="text-foreground/80 leading-relaxed">
                    ...
                    mois, taux de conversion (devis → vente), montant moyen,
                    devis en attente de réponse. Pilotez votre activité
                    data-driven.
                  </p>
                </div>
              </div>
            ...
            <section id="criteres-selection" className="mb-16">
              ...
              <p className="text-foreground/80 leading-relaxed mb-6">
                L&apos;interface doit être intuitive. Si vous devez suivre une
                formation de 2 heures pour créer votre premier devis, c&apos;est
                trop complexe. Testez la démo ou l&apos;essai gratuit : vous
                devez être autonome en moins de 10 minutes.
              </p>
              ...
              <p className="text-foreground/80 leading-relaxed mb-6">
                Les tarifs vont de 0€ (versions gratuites limitées) à
                30-50€/mois pour des solutions complètes. Calculez votre ROI :
                si vous gagnez 2h/semaine à 25€/h de valorisation, vous
                économisez 200€/mois. Payer 19,99 €/mois devient dérisoire face
                à ce gain.
              </p>
              ...
              <p className="text-foreground/80 leading-relaxed mb-6">
                ...
                français. Email, chat, téléphone ? Temps de réponse moyen ? Un
                bon support peut faire la différence quand vous bloquez sur une
                fonctionnalité.
              </p>
              ...
              <p className="text-foreground/80 leading-relaxed mb-6">
                Vos données clients (noms, emails, téléphones) sont sensibles.
                Le logiciel doit être hébergé en Europe, chiffrer les données,
                et vous permettre d&apos;exporter ou supprimer les informations
                à tout moment.
              </p>
              ...
              <p className="text-foreground/80 leading-relaxed mb-6">
                Si vous utilisez déjà un logiciel de planning (Calendly,
                Planity) ou de comptabilité, vérifiez que le logiciel de devis
                peut s&apos;y connecter ou au moins exporter des données
                compatibles (CSV, Excel).
              </p>
              ...
              <p className="text-foreground/80 leading-relaxed">
                Ne payez jamais sans avoir testé. Un essai gratuit de 14-30
                jours (ou un plan gratuit permanent) vous permet de valider que
                l&apos;outil répond à vos besoins réels avant de vous engager.
              </p>
            </section>
            ...
            <section id="comparatif" className="mb-16">
              ...
              <p className="mt-8 text-foreground/80 leading-relaxed font-semibold">
                💡 <strong>Verdict</strong> : Le logiciel spécialisé gagne sur
                tous les critères importants (temps, qualité, suivi). Le coût
                est largement compensé par le gain de temps et la
              ...
              <div className="space-y-8">
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/80 leading-relaxed">
                      Listez combien de devis vous créez par mois, quels types
                      de prestations, combien de clientes actives. Définissez
                      votre budget max (10€, 20€, 30€/mois ?). Identifiez vos
                      priorités (rapidité, personnalisation, statistiques).
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/80 leading-relaxed">
                      ...
                      existantes (nom, email, téléphone) via CSV si l&apos;outil
                      le permet, sinon créez les 10-20 principales manuellement.
                    </p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/80 leading-relaxed">
                      Si vous avez des collaboratrices, montrez-leur comment
                      créer un devis basique. La plupart des outils sont
                      intuitifs : 10 minutes de démo suffisent. Créez un petit
                      guide PDF avec screenshots si besoin.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/80 leading-relaxed">
                      Créez un devis réel pour une cliente existante. Vérifiez
                      le rendu PDF, envoyez-le par email. Demandez à la cliente
                      ce qu&apos;elle en pense (design, clarté). Ajustez si
                      besoin, puis lancez-vous en production !
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="my-12 rounded-xl bg-foreground/5 p-8 text-center border border-foreground/10">
              ...
              <p className="text-foreground/70 mb-6 max-w-2xl mx-auto">
                Rejoignez les centaines d&apos;instituts qui utilisent Solkant
                pour créer des devis professionnels en moins de 3 minutes.
              </p>
              ...
              <div className="space-y-8">
                <div className="rounded-lg border border-foreground/10 p-8 bg-gradient-to-br from-purple-50/50 to-white">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Institut traditionnel, 3 esthéticiennes, 200+ clientes
                    actives
                  </p>
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-foreground/80 leading-relaxed">
                        ...
                        fréquentes (TVA, remises). Image peu professionnelle
                        avec fichiers Excel convertis en PDF.
                      </p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-foreground mb-2">
                      ...
                      <p className="text-foreground/80 leading-relaxed">
                        Temps de création : <strong>3 min/devis</strong>.
                        Économie : 2h20/semaine = <strong>10h/mois</strong>.
                        Taux de conversion devis → vente passé de 62% à{" "}
                        <strong>78%</strong> grâce à des PDF plus professionnels
                        envoyés dans l&apos;heure. ROI : 19,99 €/mois vs 250€ de
                        temps gagné (10h × 25€/h valorisation).
                      </p>
                    </div>
                    <blockquote className="border-l-4 border-foreground pl-4 italic text-foreground/70 mt-4">
                      &quot;Solkant a transformé notre façon de travailler. Nous
                      sommes passées d&apos;une gestion artisanale à une vraie
                      structure pro. Nos clientes adorent recevoir leurs devis
                      dans l&apos;heure !&quot;
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-foreground/80 leading-relaxed">
                        ...
                        en situation. Image peu professionnelle. Oublis
                        fréquents de numérotation.
                      </p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-foreground mb-2">
                    ...
                    <blockquote className="border-l-4 border-foreground pl-4 italic text-foreground/70 mt-4">
                      &quot;Avant Solkant, je perdais des clientes à cause de
                      mes devis &apos;fait maison&apos;. Maintenant j&apos;ai un
                      rendu ultra-pro et mes clientes me recommandent énormément
                      !&quot;
                      <footer className="text-sm mt-2 not-italic">
                ...
                <div className="rounded-lg border border-foreground/10 p-8 bg-gradient-to-br from-blue-50/50 to-white">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-foreground/80 leading-relaxed">
                        Devis complexes sur Word (forfaits multi-prestations).
                        30- 40 min par devis. Remises conditionnelles calculées
                        manuellement. Retards d&apos;envoi (parfois 48h après
                        demande).
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="text-foreground/80 leading-relaxed">
                        Temps réduit à <strong>5-7 min/devis</strong>. Envoi
                        dans l&apos;heure. PDF élégant adapté à une clientèle
                        premium. Taux de conversion amélioré de{" "}
                        <strong>12 points</strong> (70% → 82%) grâce à la
                        réactivité et au design impeccable.
                      </p>
                    </div>
                    <blockquote className="border-l-4 border-foreground pl-4 italic text-foreground/70 mt-4">
                      &quot;Notre clientèle est exigeante. Solkant nous permet
                      d&apos;envoyer des devis dignes de notre standing en un
                      temps record. C&apos;est devenu indispensable.&quot;
                      <footer className="text-sm mt-2 not-italic">
                        — Sophie M., Directrice
                      </footer>
                    </blockquote>
            ...
            <section id="faq" className="mb-16">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-foreground/80 leading-relaxed">
                    Un logiciel de devis vous fait gagner 85% du temps (2-3 min
                    vs 15-20 min), calcule automatiquement les totaux et TVA,
                    génère des PDF professionnels, et centralise
                    l&apos;historique client. Excel nécessite ressaisie manuelle
                    à chaque fois avec risques d&apos;erreurs de calcul.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-foreground/80 leading-relaxed">
                    ...
                    intelligente des devis, personnalisation (logo, couleurs),
                    et statistiques de suivi.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-foreground/80 leading-relaxed">
                    ...
                    plan Solkant gratuit jusqu&apos;à 10 devis/mois) à 30€/mois
                    pour des solutions complètes. Solkant Pro coûte 19,99 €/mois
                    en illimité. Le ROI est immédiat grâce au temps gagné
                    (2h/semaine = 200€/mois valorisés).
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-foreground/80 leading-relaxed">
                    ...
                    contacts via un fichier CSV (Excel). Sinon, vous pouvez
                    créer manuellement les fiches de vos 10-20 clientes
                    principales en 30-45 minutes, puis ajouter les nouvelles au
                    fil de l&apos;eau.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-foreground/80 leading-relaxed">
                    ...
                    conditions). Vous évitez les oublis qui peuvent coûter cher
                ...
                <div>
                  ...
                  <p className="text-foreground/80 leading-relaxed">
                    ...
                    responsive. Vous pouvez créer un devis depuis votre
                    téléphone entre deux rendez-vous, ou depuis votre tablette
                    chez une cliente à domicile. Vos données sont synchronisées
                    en temps réel.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-foreground/80 leading-relaxed">
                    Vous pouvez généralement exporter toutes vos données
                    (clients, services, devis) au format PDF ou CSV avant de
                    résilier. Vos données restent accessibles pendant 30 jours
                    après l&apos;arrêt chez la plupart des éditeurs. Vérifiez
                    cette politique avant de vous engager.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-16">
              ...
              <p className="text-foreground/80 leading-relaxed mb-4">
                ...
                indispensable pour tout institut de beauté qui souhaite gagner
                du temps, professionnaliser son image, et piloter son activité
                avec des données concrètes.
              </p>
              <p className="text-foreground/80 leading-relaxed mb-4">
                Le retour sur investissement est immédiat : pour 19,99 €/mois,
                vous gagnez 8-10 heures par mois (valorisées à 200-250€) et
                améliorez votre taux de conversion grâce à des devis
                impeccables.
              </p>
              <p className="text-foreground/80 leading-relaxed">
                N&apos;attendez plus pour franchir le cap de la digitalisation.
                Testez Solkant gratuitement dès aujourd&apos;hui et créez votre
                premier devis professionnel en moins de 3 minutes.
              </p>
            </section>
            ...
            <div className="mt-12 rounded-2xl bg-gradient-to-r from-purple-600 to-pink-600 p-8 text-center text-white">
              ...
              <p className="text-lg mb-6 text-white/90 max-w-2xl mx-auto">
                Rejoignez les centaines d&apos;instituts de beauté qui utilisent
                Solkant pour gagner du temps et convertir plus de clientes.
              </p>
              <Link
                href="/register"
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground">
                    Guide complet avec mentions obligatoires, structure et
                    conseils
                  </p>
                </Link>
                <Link
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground">
                    Tous les aspects de la gestion d&apos;institut (clients,
                    finances, planning)
                  </p>
                </Link>
                <Link
