      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntityOfPage: {
              "@type": "WebPage",
              "@id": "https://solkant.com/blog/envoyer-devis-email-guide-2025",
            },
          }),
        }}
      />
      ...
      <article className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-foreground/80 leading-relaxed mb-6">
            L'envoi de devis par email permet de gagner du temps, d'améliorer la
            traçabilité et d'offrir une expérience moderne à vos clientes. Un
            devis envoyé par email est aussi juridiquement valable, à condition
          ...
          <ol className="list-decimal ml-6 mb-6">
            ...
            <li>
              Envoyez l'email à l'adresse du client et conservez une copie dans
              votre logiciel ou boîte mail.
            </li>
            <li>
          ...
          <ul className="list-disc ml-6 mb-6">
            ...
            <li>Mentions légales (ex : "devis reçu avant exécution")</li>
          </ul>
          ...
          <ul className="list-disc ml-6 mb-6">
            <li>
              Soignez l'objet de l'email (ex : "Votre devis personnalisé -
              Institut [Nom]")
            </li>
          ...
          <dl>
            ...
            <dd className="mb-4">
              Conservez l'email envoyé et la réponse du client. Un logiciel de
              devis comme Solkant archive automatiquement ces échanges.
            </dd>
            <dt className="font-semibold">
              Peut-on envoyer un devis via WhatsApp ou SMS ?
            </dt>
            <dd className="mb-4">
              Oui, mais privilégiez l'email pour la traçabilité et la conformité
              légale. WhatsApp/SMS peuvent servir de relance ou
              d'accompagnement.
            </dd>
          </dl>
        </div>
