      ...
      <article className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            Téléchargez gratuitement notre modèle de devis Word pour institut de
            beauté et découvrez nos conseils pour rédiger des devis
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="mb-6">
            Un logiciel de devis dédié permet de gagner du temps, d’automatiser
            les calculs, d’archiver les devis, de relancer les clientes et
            d’assurer la conformité légale. Idéal pour les instituts en
            croissance.
          </p>
          ...
          <dl>
            ...
            <dt className="font-semibold">Comment personnaliser le modèle ?</dt>
            <dd className="mb-4">
            ...
            <dd className="mb-4">
              Nom, coordonnées, client, date, prestations, prix, durée, mentions
              légales.
            </dd>
          </dl>
        </div>
