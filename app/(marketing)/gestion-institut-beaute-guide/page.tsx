      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            image:
              "https://www.solkant.com/images/og/pillar-gestion-institut.png",
        ...
        <article className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <header className="mb-12">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Maîtrisez tous les aspects de la gestion de votre institut de
              beauté pour gagner du temps, fidéliser vos clientes et développer
              votre chiffre d&apos;affaires. Guide pratique et actionnable.
            </p>
          </header>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section id="introduction" className="mb-16">
              <h2 className="text-3xl font-bold text-foreground mb-6">
                Introduction : Les défis de la gestion d&apos;institut au
                quotidien
              </h2>
              <p className="text-foreground/80 leading-relaxed mb-4">
                Gérer un institut de beauté ne se limite pas à maîtriser les
                techniques de soin. Entre la gestion des rendez-vous, le suivi
                des clientes, la création de devis, la comptabilité, les
                commandes de produits et le marketing, vous jonglez avec une
                dizaine de casquettes simultanément.
              </p>
              <p className="text-foreground/80 leading-relaxed mb-4">
                Cette charge mentale et administrative vous éloigne de votre
                cœur de métier : prendre soin de vos clientes et développer
                votre activité. Beaucoup d&apos;instituts fonctionnent encore
                avec des méthodes artisanales (carnets, Excel, Post-its) qui
                génèrent stress et perte de temps.
              </p>
              <p className="text-foreground/80 leading-relaxed">
                Ce guide vous montre comment structurer et optimiser la gestion
                de votre institut grâce à des méthodes éprouvées et des outils
                digitaux accessibles. L&apos;objectif : gagner 5 à 10 heures par
                semaine pour vous concentrer sur l&apos;essentiel.
              </p>
            </section>
            ...
            <section id="gestion-clients" className="mb-16">
              ...
              <p className="text-foreground/80 leading-relaxed mb-6">
                80% de votre chiffre d&apos;affaires vient de 20% de vos
                clientes fidèles. Une gestion clients optimisée vous permet de :
              </p>
              <ul className="list-disc pl-6 space-y-2 text-foreground/80 mb-6">
                <li>
                  Retrouver instantanément l&apos;historique d&apos;une cliente
                </li>
                <li>
                ...
                <li>
                  Mesurer la valeur vie client (combien dépense une cliente sur
                  1 an)
                </li>
              </ul>
              ...
              <div className="rounded-lg bg-foreground/5 p-6 mb-6">
                ...
                <ul className="list-disc pl-6 space-y-2 text-foreground/80">
                  ...
                  <li>
                    <strong>Préférences</strong> : Allergies, sensibilités
                    cutanées
                  </li>
                  <li>
                    <strong>Historique</strong> : Toutes les prestations avec
                    dates
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Statistiques</strong> : CA total, fréquence de
                    visite, panier moyen
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-4">
                <div className="rounded-lg bg-foreground/5 p-6">
                  ...
                  <p className="text-foreground/80">
                    Système de points : 1€ dépensé = 1 point. 100 points = 10€
                    de réduction. Incite aux visites régulières et augmente le
                    panier moyen.
                  </p>
                </div>
                ...
                <div className="rounded-lg bg-foreground/5 p-6">
                  ...
                  <p className="text-foreground/80">
                    Email ou SMS pour l&apos;anniversaire de la cliente avec 15%
                    de remise. Taux d&apos;ouverture de 65%+ car très
                    personnalisé.
                  </p>
                </div>
                ...
                <div className="rounded-lg bg-foreground/5 p-6">
                  ...
                  <p className="text-foreground/80">
                    Après 3 mois sans visite, envoyez un message :&quot;Vous
                    nous manquez ! 20% sur votre prochaine prestation&quot;.
                    Récupérez 25-30% des clientes perdues.
                  </p>
                </div>
              </div>
            ...
            <div className="my-12 rounded-xl bg-gradient-to-r from-purple-50 to-pink-50 p-8 text-center border border-foreground/10">
              ...
              <p className="text-foreground/70 mb-6 max-w-xl mx-auto">
                Créez des devis professionnels en 2 minutes, gérez vos clients
                et suivez vos performances. Essai gratuit.
              </p>
              <Link
                href="/register"
            ...
            <section id="gestion-devis-facturation" className="mb-16">
              ...
              <p className="text-foreground/80 leading-relaxed mb-6">
                Le devis est souvent le premier document officiel que reçoit
                votre cliente. Un devis professionnel, clair et rapide inspire
                confiance et facilite la conversion. À l&apos;inverse, un devis
                brouillon envoyé avec 2 jours de retard donne une image amateur.
              </p>
              ...
              <div className="rounded-lg bg-gradient-to-r from-purple-100 to-pink-100 p-6 mb-6">
                ...
                <ul className="space-y-2 text-foreground/80">
                  <li>
                    ✅ <strong>Gain de temps :</strong> 15 min → 2 min par devis
                    (85% de gain)
                  </li>
                  <li>
                    ✅ <strong>Taux de conversion :</strong> +12-15 points grâce
                    à l&apos;envoi rapide
                  </li>
                  <li>
                    ✅ <strong>Image professionnelle :</strong> PDF élégants
                    avec logo
                  </li>
                  <li>
                    ✅ <strong>Conformité :</strong> Mentions obligatoires
                    automatiques
                  </li>
                  <li>
                    ✅ <strong>Suivi :</strong> Statut des devis (envoyé,
                    accepté, refusé)
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 text-sm">
                      Démarquez-vous : envoyez dans l&apos;heure suivant la
                      demande
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-8 rounded-lg bg-foreground/5 p-6">
                ...
                <ul className="space-y-2 text-foreground/80">
                  ...
                  <li>
                    <strong>Délai moyen d&apos;envoi</strong> : Objectif &lt;
                    24h
                  </li>
                  <li>
                    <strong>Montant moyen par devis</strong> : Suivre
                    l&apos;évolution
                  </li>
                  <li>
                    <strong>Nombre de devis/mois</strong> : Indicateur
                    d&apos;activité
                  </li>
                </ul>
              </div>
            ...
            <section id="organisation-planning" className="mb-16">
              ...
              <div className="space-y-4">
                <div className="rounded-lg bg-foreground/5 p-6">
                  ...
                  <p className="text-foreground/80">
                    Proposez un système de réservation en ligne (Calendly,
                    Planity, Treatwell). Vos clientes réservent même à 22h, vous
                    validez le lendemain. Gain : 30-40% de réservations en plus.
                  </p>
                </div>
                ...
                <div className="rounded-lg bg-foreground/5 p-6">
                  ...
                  <p className="text-foreground/80">
                    ...
                    15-20%. &quot;Bonjour Julie, RDV demain à 14h pour soin
                    visage. À bientôt !&quot;
                  </p>
                </div>
                ...
                <div className="rounded-lg bg-foreground/5 p-6">
                  ...
                  <p className="text-foreground/80">
                    Annulation gratuite jusqu&apos;à 24h avant, sinon 50% du
                    montant dû. Communiquez-le clairement dès la réservation.
                    Responsabilise les clientes.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section id="gestion-financiere" className="mb-16">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div className="rounded-lg bg-gradient-to-br from-blue-50 to-white p-6 border border-foreground/10">
                  ...
                  <p className="text-foreground/70 text-sm">
                    Total des ventes du mois. Comparez mois par mois pour voir
                    la tendance.
                  </p>
                </div>
                ...
                <div className="rounded-lg bg-gradient-to-br from-green-50 to-white p-6 border border-foreground/10">
                  ...
                  <p className="text-foreground/70 text-sm">
                    CA total / nombre de clientes. Objectif : augmenter via
                    upsell et forfaits.
                  </p>
                </div>
                ...
                <div className="rounded-lg bg-gradient-to-br from-purple-50 to-white p-6 border border-foreground/10">
                  ...
                  <p className="text-foreground/70 text-sm">
                    % de clientes revenues au moins 2 fois dans l&apos;année.
                    Objectif : &gt; 60%.
                  </p>
                </div>
                ...
                <div className="rounded-lg bg-gradient-to-br from-pink-50 to-white p-6 border border-foreground/10">
                  ...
                  <p className="text-foreground/70 text-sm">
                    CA - coûts produits. Visez 60-70% de marge sur les
                    prestations.
                  </p>
                </div>
              </div>
              ...
              <p className="text-foreground/80 leading-relaxed mb-4">
                Même si vous avez un comptable, facilitez-lui la vie (et
                réduisez ses honoraires) en tenant un minimum de suivi :
              </p>
              <ul className="list-disc pl-6 space-y-2 text-foreground/80 mb-6">
                <li>
                  <strong>Fichier Excel mensuel</strong> : Recettes par jour,
                  TVA collectée
                </li>
                <li>
                ...
                <li>
                  <strong>Export logiciel devis</strong> : Si vous utilisez
                  Solkant, exportez mensuellement
                </li>
              </ul>
            </section>
            ...
            <section id="outils-recommandes" className="mb-16">
              ...
              <div className="space-y-6">
                <div className="rounded-lg border border-foreground/10 p-6">
                  ...
                  <p className="text-foreground/80 mb-3">
                    <strong>Usage :</strong> Création de devis PDF
                    professionnels, gestion clients, catalogue services,
                    statistiques.
                  </p>
                  <p className="text-foreground/70 text-sm mb-2">
                    <strong>Prix :</strong> Gratuit jusqu&apos;à 10 devis/mois,
                    puis 19,99 €/mois illimité
                  </p>
                ...
                <div className="rounded-lg border border-foreground/10 p-6">
                  ...
                  <p className="text-foreground/80 mb-2">
                    <strong>Usage :</strong> Facturation, déclarations TVA,
                ...
                <div className="rounded-lg border border-foreground/10 p-6 bg-foreground/5">
                  ...
                  <p className="text-foreground/70 text-sm">
                    <strong>Prix :</strong> Brevo gratuit jusqu&apos;à 300
                    emails/jour
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8 rounded-lg bg-gradient-to-r from-purple-100 to-pink-100 p-6">
                ...
                <ul className="space-y-2 text-foreground/80">
                  <li>
                    <strong>Essentiel (démarrage)</strong> : 20-30€/mois
                    (Solkant + Planity)
                  </li>
                  <li>
                    <strong>Complet (croissance)</strong> : 50-70€/mois (+
                    compta + marketing)
                  </li>
                  <li>
                    <strong>ROI</strong> : Gain de 8-10h/mois = 200-250€
                    valorisés
                  </li>
                </ul>
              </div>
            ...
            <section id="checklist-30-jours" className="mb-16">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-foreground/80">
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        Listez tous vos outils actuels (Excel, carnets,
                        Post-its)
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-purple-600 font-bold">☐</span>
                      <span>
                        Identifiez les 3 plus grosses pertes de temps (ex:
                        création devis, recherche infos clients)
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-purple-600 font-bold">☐</span>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-foreground/80">
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        Créez votre compte Solkant (gratuit jusqu&apos;à 10
                        devis/mois)
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-foreground/80">
                    ...
                    <li className="flex items-start gap-3">
                      <span className="text-blue-600 font-bold">☐</span>
                      <span>
                        Configurez les rappels automatiques par SMS/email
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-blue-600 font-bold">☐</span>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-foreground/80">
                    ...
                    <li className="flex items-start gap-3">
                      <span className="text-green-600 font-bold">☐</span>
                      <span>
                        Ajustez vos process si nécessaire (templates de
                        messages, automatisations)
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="mt-8 rounded-lg bg-gradient-to-r from-green-50 to-blue-50 p-6">
                ...
                <ul className="space-y-2 text-foreground/80">
                  <li>
                    ✅ 5-10h/semaine gagnées sur les tâches administratives
                  </li>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-foreground/80 leading-relaxed">
                    ...
                    Utilisez un logiciel comme Solkant (gratuit pour démarrer)
                    qui vous fera gagner 2h/semaine dès le premier mois.
                    Ensuite, ajoutez la prise de RDV en ligne (Planity), puis
                    les autres outils.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-foreground/80 leading-relaxed">
                    ...
                    personnalisée (anniversaires, offres ciblées), et relance
                    des inactives après 3 mois. Une base clients bien gérée vous
                    permet d&apos;automatiser ces actions.
                  </p>
                </div>

                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-2">
                    Combien de temps pour voir les bénéfices de la
                    digitalisation ?
                  </h3>
                  <p className="text-foreground/80 leading-relaxed">
                    Dès le premier mois pour le gain de temps (devis, RDV).
                    Après 3-6 mois pour l&apos;amélioration du CA (meilleur taux
                    de conversion, fidélisation accrue, upsell facilité).
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-16">
              ...
              <p className="text-foreground/80 leading-relaxed mb-4">
                Optimiser la gestion de votre institut de beauté n&apos;est plus
                une option en 2025. Vos concurrentes digitalisent leurs
                processus, vos clientes attendent réactivité et
                professionnalisme.
              </p>
              <p className="text-foreground/80 leading-relaxed mb-4">
                Commencez petit : digitalisez vos devis avec Solkant cette
                semaine, puis ajoutez progressivement d&apos;autres outils
                (planning, marketing). En 30 jours, vous aurez transformé votre
                quotidien et libéré 8-10h par mois pour ce qui compte vraiment.
              </p>
              <p className="text-foreground/80 leading-relaxed">
            ...
            <div className="mt-12 rounded-2xl bg-gradient-to-r from-purple-600 to-pink-600 p-8 text-center text-white">
              ...
              <p className="text-lg mb-6 text-white/90 max-w-2xl mx-auto">
                Créez votre compte Solkant gratuit et digitalisez vos devis en
                10 minutes. Première étape vers une gestion optimisée.
              </p>
              <Link
                href="/register"
